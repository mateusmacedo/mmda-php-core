...
use MMDA\Core\Domain\Validators\AttributeValidatorComposite;
use Tests\TestCase;
...
class AttributeValidatorCompositeTest extends TestCase
{
    ...
    {
        $validator1 = $this->createMock(\MMDA\Core\Domain\Validators\Validator::class);
        $validator1->method('validate')->willReturn(true);
        $validator1->method('getErrorMessage')->willReturn('error1');

        $validator2 = $this->createMock(\MMDA\Core\Domain\Validators\Validator::class);
    ...
    public function testValidateFail(): void
    {
        ...
        $validator3 = $this->createMock(\MMDA\Core\Domain\Validators\Validator::class);
